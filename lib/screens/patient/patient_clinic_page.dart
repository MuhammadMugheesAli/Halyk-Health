      ...
      children: [
        Row(
          ...
          children: [
            ...
            ], onChanged: (val) => setState(() => filter=val!),value: filter,),
          ],
        ),
        Expanded(
          child: StreamBuilder(
              stream: filter == 'paid' ? patient.paidClinics : filter == 'free' ? patient.freeClinics : patient.clinics,
              builder: (context, AsyncSnapshot<QuerySnapshot> streamSnapshot) {
                ...
                return ListView.builder(
                      itemBuilder: (ctx, index) {
                        var data = Clinic.fromMap(streamSnapshot.data!.docs[index].data()
